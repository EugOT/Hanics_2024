...
markers_logreg <- markers_logreg[str_detect(pattern = var_regex, string = markers_logreg$gene, negate = TRUE), ]
...
markers_logreg %>%
  ...
  right_join(markers_logreg, by = c("name" = "gene"))
...
markers_MAST <- markers_MAST[str_detect(pattern = var_regex, string = markers_MAST$gene, negate = TRUE), ]
...
markers_MAST %>%
  ...
  select(name, description) %>%
  right_join(markers_MAST, by = c("name" = "gene"))
